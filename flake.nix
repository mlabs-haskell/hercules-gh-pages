            ...
            hci-effects.runIf (primaryRepo.ref == "refs/heads/main" || primaryRepo.ref == "refs/heads/master") (
              hci-effects.mkEffect {
                ...
                effectScript =
                  ...
                  in
                  ''
                    echo ${primaryRepo.remoteHttpUrl}
                    ...
                    git remote add origin https://${primaryRepo.owner}:`readSecretString git .token`@github.com/${primaryRepo.owner}/${primaryRepo.name}.git
                    git add .
